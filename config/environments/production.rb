Knight::Application.configure do
  ...
  if !Rails.env.development? && !Rails.env.test?
    ...
    config.middleware.insert_before Rack::Cache, Rack::AssetServer, urls: [config.assets.prefix], root: 'public', headers: { 'Cache-Control' => 'public, max-age=31536000', 'Access-Control-Allow-Origin' => '*', 'Access-Control-Allow-Headers' => '*, X-Requested-With, X-Prototype-Version, X-CSRF-Token', 'Access-Control-Allow-Methods' => 'POST, GET, OPTIONS', 'Access-Control-Max-Age' => '2592000' }
